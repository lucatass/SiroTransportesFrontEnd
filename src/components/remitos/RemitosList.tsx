...
const RemitosList: React.FC = () => {
  ...
  const columnDefs: ColDef[] = [
    { headerName: 'Nombre y Apellido', field: 'nombre', sortable: true, filter: true, width: 150 },
    { headerName: 'ID', field: 'remitosid', sortable: false, filter: true, width: 100 },
  ...
  return (
    <div>
      ...
      {/* AG Grid Table */}
      <div className="ag-theme-alpine" style={{ height: 400, width: '250px' }}>
        <AgGridReact

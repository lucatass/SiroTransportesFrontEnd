...
var HeaderCellComp = ({ ctrl }) => {
  ...
  const cssClassManager = (0, import_react14.useRef)();
...
var HeaderFilterCellComp = ({ ctrl }) => {
  ...
  const reactUserComp = userCompDetails && userCompDetails.componentFromFramework;
  const UserCompClass = userCompDetails && userCompDetails.componentClass;
  return import_react15.default.createElement("div", { ref: setRef2, className, role: "gridcell" }, import_react15.default.createElement("div", { ref: eFloatingFilterBody, className: bodyClassName, role: "presentation" }, reactUserComp && !reactiveCustomComponents && import_react15.default.createElement(UserCompClass, { ...userCompDetails.params, ref: userCompStateless ? () => {
...
var HeaderGroupCellComp = ({ ctrl }) => {
  ...
  const colId = (0, import_react16.useMemo)(() => ctrl.getColId(), []);
  ...
  const reactUserComp = userCompDetails && userCompDetails.componentFromFramework;
  const UserCompClass = userCompDetails && userCompDetails.componentClass;
  return import_react16.default.createElement("div", { ref: setRef2, className, "col-id": colId, role: "columnheader", "aria-expanded": ariaExpanded }, import_react16.default.createElement("div", { ref: eHeaderCompWrapper, className: "ag-header-cell-comp-wrapper", role: "presentation" }, reactUserComp && userCompStateless && import_react16.default.createElement(UserCompClass, { ...userCompDetails.params }), reactUserComp && !userCompStateless && import_react16.default.createElement(UserCompClass, { ...userCompDetails.params, ref: userCompRef })), import_react16.default.createElement("div", { ref: eResize, "aria-hidden": resizableAriaHidden, className: resizableClassName }));
};
...
var HeaderRowComp = ({ ctrl }) => {
  ...
  const [cellCtrls, setCellCtrls] = (0, import_react13.useState)(() => ctrl.getHeaderCtrls());
...
var HeaderRowContainerComp = ({ pinned }) => {
  ...
  return import_react12.default.createElement(import_react12.default.Fragment, null, pinnedLeft && import_react12.default.createElement(
    ...
    insertRowsJsx()
  ), centre && import_react12.default.createElement("div", { ref: setRef2, className: "ag-header-viewport " + className, role: "presentation" }, import_react12.default.createElement("div", { ref: eCenterContainer, className: "ag-header-container", role: "rowgroup" }, insertRowsJsx())));
};
...
var PopupEditorComp = (props) => {
  ...
  const { context, popupService, localeService, gos, editService } = (0, import_react21.useContext)(BeansContext);
  useEffectOnce(() => {
    var _a2, _b;
...
var CellComp = ({
  ...
  (0, import_react20.useLayoutEffect)(() => {
    ...
    (_a2 = cellCtrl.getRowCtrl()) == null ? void 0 : _a2.setInlineEditingCss();
  ...
  const onBlur = (0, import_react20.useCallback)(() => cellCtrl.onFocusOut(), []);
  return import_react20.default.createElement("div", { ref: setRef2, style: userStyles, role: cellAriaRole, "col-id": colIdSanitised, onBlur }, showCellWrapper ? import_react20.default.createElement("div", { className: "ag-cell-wrapper", role: "presentation", ref: setCellWrapperRef }, showContents()) : showContents());
};
...
var RowComp = ({ rowCtrl, containerType }) => {
  ...
  const [rowIndex, setRowIndex] = (0, import_react19.useState)(() => isDisplayed ? rowCtrl.getRowIndex() : null);
  const [rowId, setRowId] = (0, import_react19.useState)(() => rowCtrl.getRowId());
  const [rowBusinessKey, setRowBusinessKey] = (0, import_react19.useState)(() => rowCtrl.getBusinessKey());
  const [userStyles, setUserStyles] = (0, import_react19.useState)(() => rowCtrl.getRowStyles());
...
var RowContainerComp = ({ name }) => {
  ...
  return import_react18.default.createElement(import_react18.default.Fragment, null, isCenter ? import_react18.default.createElement("div", { className: viewportClasses, ref: setViewportRef, role: "presentation" }, buildContainer()) : buildContainer());
};
var rowContainerComp_default = (0, import_react18.memo)(RowContainerComp);
var GridBodyComp = () => {
  const { context, resizeObserverService } = (0, import_react10.useContext)(BeansContext);
  ...
  const [topDisplay, setTopDisplay] = (0, import_react10.useState)("");
  const [bottomDisplay, setBottomDisplay] = (0, import_react10.useState)("");
  ...
  const cssClassManager = (0, import_react10.useRef)();
  if (!cssClassManager.current) {
  ...
  const topClasses = (0, import_react10.useMemo)(() => classesList("ag-floating-top", cellSelectableCss), [cellSelectableCss]);
  ...
  const bottomClasses = (0, import_react10.useMemo)(() => classesList("ag-floating-bottom", cellSelectableCss), [cellSelectableCss]);
  ...
  return import_react10.default.createElement("div", { ref: setRef2, className: rootClasses, role: "treegrid" }, import_react10.default.createElement(gridHeaderComp_default, null), createSection({
    section: eTop,
...
var GridComp = ({ context }) => {
  ...
  const [gridThemeClass, setGridThemeClass] = (0, import_react9.useState)("");
